...
const defaultAffairs: AffairType[] = [ // need to fix any
    ...
    {_id: 6, name: 'SQL', priority: 'middle'},
    {_id: 7, name: 'JS', priority: 'high'},
    {_id: 8, name: 'Typescript', priority: 'high'},
    {_id: 9, name: 'C#', priority: 'middle'},
    {_id: 10, name: '.Net', priority: 'middle'},
    {_id: 11, name: 'Angular', priority: 'middle'},
]
